...
type options struct {
	...
	serverTLSConfig certloader.ServerConfig
	insecureServer  bool
	clientTLSConfig certloader.ClientConfig
	insecureClient  bool
...
func WithServerTLS(cfg certloader.ServerConfig) Option {
	return func(o *options) error {
...
func WithClientTLS(cfg certloader.ClientConfig) Option {
	return func(o *options) error {
